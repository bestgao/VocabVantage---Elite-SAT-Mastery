  ...
  return (
    <div className="max-w-2xl mx-auto min-h-[70vh] flex flex-col items-center justify-center space-y-8 md:space-y-12 px-4 animate-in zoom-in-95 duration-500">
      <div className="text-center space-y-3 md:space-y-4">
        ...
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter">Session Complete</h2>
        <p className="text-slate-500 font-medium text-base md:text-lg">Your review schedule and progress insights were updated.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 w-full">
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-slate-100 shadow-sm text-center space-y-1 md:space-y-2">
          ...
          <p className="text-[9px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest">Words Reviewed</p>
        </div>
      </div>
